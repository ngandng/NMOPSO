...
% randPa.r = unifrnd(VarMin.r, VarMax.r, VarSize);
% randPa.psi = unifrnd(VarMin.psi, VarMax.psi, VarSize);
% randPa.phi = unifrnd(VarMin.phi, VarMax.phi, VarSize);
% nObj = numel(CostFunction(SphericalToCart2(randPa,model)));
